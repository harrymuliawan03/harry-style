export default function About() {
  return (
    <section className="flex flex-col mx-5 md:mx-0 mb-20 md:mb-0">
      <div className="flex flex-col space-y-6 font-sans text-neutral-800 dark:text-neutral-300">
        <p>
          ...
          frameworks, I heve been navigating the ever-evolving landscape of web
          development with enthusiasm and dedication. Currently, reside in
          Bekasi, Indonesia 🇮🇩.
        </p>
        <p>
          ...
          nature allows me to seamlessly integrate with teams, contributing not
          only my technical prowess but also a humble attitude that values every
          members input.
        </p>
        <p>
          When I am not immersed in lines of code, you might find me exploring
          the latest trends in the tech world, tinkering with personal coding
          projects, or engaging in thought-provoking discussions on software
