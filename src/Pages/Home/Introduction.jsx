...
export default function Introduction() {
  return (
    <section className="flex flex-wrap">
      <div className="relative w-full mx-4 mt-24 md:my-0 md:mx-0 self-center lg:w-1/2">
        ...
        <div className="absolute right-32 top-72 md:right-[12rem] md:top-[17.5rem] animate-heart">
      ...
      <div className="w-full self-end px-4 lg:w-1/2">
        <div className="relative mt-2 lg:right-0 lg:mt-9">
          ...
          />
          <span className="absolute bottom-0 left-1/2 -translate-x-1/2 md:scale-150 animate-fade_in">
            <svg
              className="w-[613px] h-[376px] md:h-[420px]"
              viewBox="0 0 200 200"
            ...
            >
              <path
                ...
                className=" translate-x-20 md:translate-x-[5rem] translate-y-[9rem] md:translate-y-[6rem] rotate-[-10deg] scale-125 md:scale-100"
              />
            </svg>
          </span>
        </div>
