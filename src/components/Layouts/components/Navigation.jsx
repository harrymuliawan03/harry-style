...
export default function Navigation({active}) {
  return (
    <nav
      id="nav-menu"
      className={`z-[9999] md:h-auto rounded-lg bg-white py-2 dark:bg-dark dark:shadow-slate-500 lg:static lg:block lg:max-w-full lg:rounded-none lg:bg-transparent lg:dark:bg-transparent`}
    >
